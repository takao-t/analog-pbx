...
IPユニットをI2C接続したらSLICユニットの枚数を減らさなくていいので、4+1の構成とか作れるんじゃね？と思いついたのですが、実装する前に当たり前の話に気付いてやめました。

そうです、そもそも交換台(スイッチボード)の収容可能容量に縛られるので、回線制御のユニット数が増えたらスイッチボードも増やさないといけないので意味ないのでした。ただ8x8のスイッチボードを用意しておくというのはアリではあるのですが、その場合にはI/OエクスパンダでIPユニットを繋げばいいので無駄な努力になるところでしたわ。